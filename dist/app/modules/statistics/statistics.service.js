...
const getUser = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const totalActiveUsersPromise = user_model_1.User.countDocuments({ isActive: "Active" });
    const totalBlockedUsersPromise = user_model_1.User.countDocuments({ isActive: "Blocked" });
    const totalInactiveUsersPromise = user_model_1.User.countDocuments({ isActive: "Inactive" });
    ...
    const [totalUsers, totalActiveUsers, totalBlockedUsers, totalInactiveUsers, newUsersInLast7Days, newUsersInLast30Days, usersByRole] = yield Promise.all([
        totalUsersPromise,
...
const getBooking = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const totalBookingByUniqueUsersPromise = booking_model_1.Booking.distinct("users").then((user) => user.length);
...
const getPayment = () => __awaiter(void 0, void 0, void 0, function* () {
