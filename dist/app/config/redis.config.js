...
exports.redisClient = (0, redis_1.createClient)({
    username: 'default',
    password: env_config_1.envVars.REDIS_OTP.REDIS_PASSWORD,
    socket: {
        host: env_config_1.envVars.REDIS_OTP.REDIS_HOST,
        port: Number(env_config_1.envVars.REDIS_OTP.REDIS_PORT)
    }
});
