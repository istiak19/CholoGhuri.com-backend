...
const userCreateToken = (user) => {
    ...
    const accessToken = (0, jwt_1.generateToken)(jwtPayload, env_config_1.envVars.JWT_SECRET, env_config_1.envVars.JWT_EXPIRES_IN);
    const refreshToken = (0, jwt_1.generateToken)(jwtPayload, env_config_1.envVars.JWT_REFRESH_SECRET, env_config_1.envVars.JWT_REFRESH_EXPIRES_IN);
    return {
        accessToken,
        refreshToken
    };
...
const createNewAccessTokenWithRefreshToken = (refreshToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (isExist.isActive === "Blocked" || isExist.isActive === "Inactive") {
        throw new AppError_1.AppError(http_status_1.default.BAD_REQUEST, `User is ${isExist.isActive}`);
    }
