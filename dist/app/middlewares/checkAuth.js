...
const checkAuth = (...authRoles) => (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        ;
        const verifiedToken = (0, jwt_1.verifyToken)(accessToken, env_config_1.envVars.JWT_SECRET);
        ...
        if (!authRoles.includes(verifiedToken.role)) {
            throw new AppError_1.AppError(403, "Unauthorized access: Insufficient role");
        }
        ;
